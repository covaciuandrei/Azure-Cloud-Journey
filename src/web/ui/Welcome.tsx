...
export function Welcome({ course, progress, questionCount, onLearn, onPractice }: {
  course: Course | null;
  ...
  return <section className="study-welcome">
    ...
    <div className="study-entry-options">
      ...
      <article className="welcome-practice">
        ...
        <ul className="welcome-features"><li><Icon name="check" size={16} />Free practice in sets of 10, 20, 30 or 40</li><li><Icon name="check" size={16} />40-question exams with a 60-minute timer</li><li><Icon name="check" size={16} />Your saved sessions, results and history</li></ul>
